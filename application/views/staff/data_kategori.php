    ...
    <table class="table table-bordered">
        ...
        foreach ($data_kategori as $ktr) : ?>
            ...
            <tr align="center">
                ...
                <td><?php echo anchor('staff/data_kategori/edit/' . $ktr->id_kategori, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                <td><?php echo anchor('staff/data_kategori/hapus/' . $ktr->id_kategori, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
            </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() . 'staff/data_kategori/tambah_aksi_kategori';
                                    ?>" method="post">
